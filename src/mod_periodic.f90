module mod_periodic
  ...
  private  
  public :: init_periodic_table, ptable, atom, label2z, nelem
  ...
  type atom
    ...
    integer :: e_conv(0:3) ! electrons per symmetry [s,p,d,f]
...
contains
  ...
  integer function label2z(label)
    integer :: i
    ...
    label2z = 0
    do i = 1,nelem
      call upper(ptable(i)%symbol)
      if(label.eq.ptable(i)%symbol) then
        label2z = i
        exit
      endif
    enddo
