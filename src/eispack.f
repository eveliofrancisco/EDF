...
c
      ...
      real(kind=8) ar(nm,n),ai(nm,n),w(n),zr(nm,n),zi(nm,n),
...
c
      ...
      real(kind=8) ar(nm,n),ai(nm,n),tau(2,n),zr(nm,m),zi(nm,m)
      real(kind=8) h,s,si
c
c     this subroutine is a translation of a complex analogue of
...
c
      ...
      real(kind=8) ar(nm,n),ai(nm,n),d(n),e(n),e2(n),tau(2,n)
      real(kind=8) f,g,h,fi,gi,hh,si,scale,pythag
c
c     this subroutine is a translation of a complex analogue of
...
c
      ...
      real(kind=8) d(n),e2(n)
      real(kind=8) b,c,f,g,h,p,r,s,t,epslon,pythag
c
...
c
      ...
      real(kind=8) d(n),e(n),z(nm,n)
      real(kind=8) c,c2,c3,dl1,el1,f,g,h,p,r,s,s2,tst1,tst2,pythag
c
