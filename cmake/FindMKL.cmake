...
if(MKL_FOUND AND NOT TARGET MKL::MKL)
    ...
    if(NOT APPLE)
        target_link_libraries(MKL::MKL INTERFACE  -Wl,--start-group ${MKL_INTERFACE_LIBRARY} ${MKL_INTEL_THREAD} ${MKL_CORE_LIBRARY} -Wl,--end-group iomp5 pthread m dl)
    else()
        target_link_libraries(MKL::MKL INTERFACE ${MKL_INTERFACE_LIBRARY} ${MKL_INTEL_THREAD} ${MKL_CORE_LIBRARY} iomp5 pthread m dl)
    endif()
endif()